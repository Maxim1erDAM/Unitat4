...
public class App {
	...
	System.out.println("El número major entre els dos números pasats com a arguments, que són: "+operand1+" i "+operand2+". El major es el número:"+myCalc.majorque(operand1, operand2));
